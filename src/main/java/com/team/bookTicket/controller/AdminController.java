...
public class AdminController {
	...
	public List<Course> getMovies(Integer page, Integer limit){
		return adminService.allMovie(page, limit);
	}
	@GetMapping("/get/movie/{id}")
	public Course getMovie(@PathVariable Integer id) {
		return adminService.getMovie(id);
	}
	@PostMapping("/add/movie")
	public void addMovie(Course course) {
		if(course.canAdd()) {
			adminService.addMovie(course);
		}
	}
	@PostMapping("/update/movie")
	public void updateMovie(Course course) {
		if(course.canUpdate()) {
			adminService.updateMovie(course);
		}
	}
